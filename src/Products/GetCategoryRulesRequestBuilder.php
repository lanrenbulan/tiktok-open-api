...
/**
 * @see https://partner.tiktokshop.com/docv2/page/6509c0febace3e02b74594a9
 */
class GetCategoryRulesRequestBuilder extends AbstractOpenApiRequestBuilder
{
    use ShopCipherTrait;
    ...
    {
        return '/product/202309/categories/' . $this->pathParams['category_id'] . '/rules';
    }
}